...
import { Home, BookOpen, Play, Settings, Search, ChevronDown, ChevronUp, ArrowLeft, CheckCircle, Clock } from 'lucide-react';
import { useRouter, usePathname } from 'next/navigation';
import Link from 'next/link';
import UserMenu from '../../../components/UserMenu';

// Last updated by manabunagaoka: 2025-06-11 13:02:47
...
const ModuleCard = ({ moduleId, courseId, title, description, duration, completed, isExpanded, onToggle, onStartModule }) => {
        ...
        {moduleId === 'nutrition-fundamentals' ? (
          <div className="p-4">
            ...
            <div className="flex justify-center">
              <button 
                className="bg-[#FFD166] text-white py-2 px-8 rounded-full font-medium shadow-sm hover:bg-[#FFC13D] transition-colors"
...
export default function NutritionCourse() {
  ...
  // Handle back navigation to learning page with correct transition
